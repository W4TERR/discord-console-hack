...
```
2. **Go on the discord site and type in your search bar "javascript:" since when you paste the javascript: part it doesn't paste anything...** 
3. Then paste the script
4. Press **enter**
5. Enjoy Your Theme
